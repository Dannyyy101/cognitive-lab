    ...
    return (
        <section className="flex flex-col items-center h-[40rem] relative w-[60rem]">
            ...
            <section className="w-2/3 flex flex-col  mt-8">
                ...
                <button className="absolute right-8 bottom-8 w-32 bg-bgColor_accent_emphasis text-fgColor_white h-10 rounded-md flex justify-center items-center" onClick={handleSaveNewSubject}>save</button>
            </section>
        </section>
    );
};
